...
/**
 * Query that can search through data. Has similar (but not equal) to SQL structure
 *
...
public interface Query<T> {
     ...
     * @return QueryResult
     */
    @NotNull <K> QueryResult<T> whereEqual(Function<T, K> function, K compare);
     ...
     * @return QueryResult
     */
    @NotNull <K> QueryResult<T> whereNotEqual(Function<T, K> function, K compare);
