...
public class BorderlessScrollPane extends JLayeredPane {
     ...
     */
    public BorderlessScrollPane(final JComponent view, int vsbPolicy, int hsbPolicy) {
        setBorder(null);
    ...
    private class ControlPanel extends JPanel {
        ...
        private ControlPanel(@NotNull JScrollPane scrollPane) {
            setLayout(null);
            setOpaque(false);
            ...
            if (scrollPane.getVerticalScrollBarPolicy()
    ...
    private class JMyScrollBar extends JScrollBar {
        ...
        private JMyScrollBar(int direction) {
            super(direction);
            this.putClientProperty("scrollBar.updateBackground", Boolean.FALSE);
            this.putClientProperty("scrollBar.updateAction",
                                   (Runnable) () -> scrollPane.getViewport().repaint());
            setOpaque(false);
        }
