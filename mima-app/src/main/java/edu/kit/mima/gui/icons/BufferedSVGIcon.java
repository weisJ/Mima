 ...
 */
public class BufferedSVGIcon extends UserAgentAdapter implements Icon {
     ...
     * @throws TranscoderException if file cannot be transcoded.
     */
    public BufferedSVGIcon(final String uri, final int w, final int h) throws TranscoderException {
     ...
     * @throws TranscoderException if file cannot be transcoded.
     */
    public BufferedSVGIcon(final Document doc) throws TranscoderException {
        this(doc, 0, 0);
    }
