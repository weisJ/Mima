...
public class DefaultFontSelectionModel implements FontSelectionModel {
    ...
    /**
     * Only one {@code ChangeEvent} is needed per model instance since the event's only (read-only)
     * state is the source property. The source of events generated here is always "this".
     */
     ...
     * should be non-{@code null}. Note that setting the font to {@code null} is undefined and may
     * have unpredictable results.
     *
     * @param font the new {@code Font}
     */
    public DefaultFontSelectionModel(@NotNull final Font font) {
        selectedFont = font;
    }
    ...
    /**
     * Returns an array of all the {@code ChangeListener}s added to this {@code
