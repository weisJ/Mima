...
public class StylePane extends JScrollPane implements ChangeListener {
    ...
    public void loadFamily(final String family) {
        ...
        if (fontFamily != null) {
            final ListSelectionListener[] selectionListeners = styleList.getListSelectionListeners();
    ...
    private void addSelectionListeners(@NotNull final ListSelectionListener[] selectionListeners) {
        for (final ListSelectionListener listener : selectionListeners) {
            styleList.addListSelectionListener(listener);
        }
    }

    private void removeSelectionListeners(@NotNull final ListSelectionListener[] selectionListeners) {
        for (final ListSelectionListener listener : selectionListeners) {
            styleList.removeListSelectionListener(listener);
        }
    }
